...
public class WorldGenCustomForest extends WorldGenerator {

	Block saplingType;
	Block logType;
	Block leafType;
	
	public WorldGenCustomForest(boolean sapling, Block saplingType, Block log, Block leaf) {
		super(sapling);
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isValidSoil = soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (IPlantable)saplingType);
                ...
                if (isValidSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (l1 = par3 - k1; l1 <= par3 + k1; ++l1)
                        {
                            ...
                            for (int k2 = par5 - k1; k2 <= par5 + k1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != k1 || Math.abs(l2) != k1 || par2Random.nextInt(2) != 0 && j1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(par1World, l1, i2, k2, leafType.blockID, 0);
                                    }
                                }
                            }
                        }
                    ...
                    for (i2 = 0; i2 < l; ++i2)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + i2, par5, logType.blockID, 0);
                        }
                    }
