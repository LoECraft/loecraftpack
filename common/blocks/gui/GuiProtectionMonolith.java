...
public class GuiProtectionMonolith extends GuiScreen
{
	...
	TileProtectionMonolith te;
	
	public GuiProtectionMonolith(TileProtectionMonolith te)
	{
		this.te = te;
	}
	...
	public void drawScreen(int x, int y, float f)
	{
		...
		this.mc.renderEngine.bindTexture("/loecraftpack/resources/mods/loecraftpack/gui/monolith.png");
