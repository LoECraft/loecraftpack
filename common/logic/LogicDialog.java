...
public class LogicDialog
{
	...
	public static boolean ChangeMessage(boolean forward)
	{
		...
		else if (index >= messages.size())
		{
			...
			{
				LogicQuest.parseQuest(questParams);
				questParams = null;
				return true;
			}
		}
		...
		if (Minecraft.getMinecraft().currentScreen instanceof GuiDialog)
			((GuiDialog)Minecraft.getMinecraft().currentScreen).changeButtons(button.ordinal());
