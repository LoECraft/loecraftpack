...
public class ModelTimberWolf extends ModelBase
{
    ...
    {
        EntityTimberWolf entityTimberWolf = (EntityTimberWolf)entityLiving;

        if (entityTimberWolf.isAngry())
        {
        ...
        this.wolfHeadMain.rotateAngleZ = entityTimberWolf.getInterestedAngle(par4) + entityTimberWolf.getShakeAngle(par4, 0.0F);
        this.wolfMane.rotateAngleZ = entityTimberWolf.getShakeAngle(par4, -0.08F);
        this.wolfBody.rotateAngleZ = entityTimberWolf.getShakeAngle(par4, -0.16F);
        this.wolfTail.rotateAngleZ = entityTimberWolf.getShakeAngle(par4, -0.2F);
    }
