...
public class DialogGUI extends GuiScreen
{
	...
	public void drawScreen(int x, int y, float f)
	{
		...
		drawCenteredString(fontRenderer, DialogLogic.dialogTitle, posX + xSizeOfTexture/2, posY + 9, white);
		
		for(int i = 0; i < DialogLogic.dialogText.length; i++ )
			drawCenteredString(fontRenderer, DialogLogic.dialogText[i], posX + xSizeOfTexture/2, posY + 31 + i*11, white);
