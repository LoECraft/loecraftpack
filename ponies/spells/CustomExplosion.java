package loecraftpack.ponies.spells;
...
public class CustomExplosion extends Explosion
{
	...
	public CustomExplosion(World world, float size, float damage, double x, double y, double z)
	{
	...
	{
        CustomExplosion explosion = new CustomExplosion(world, size, damage, x, y, z);
